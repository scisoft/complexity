...
set term postscript eps size 10in,7.5in font 'HumorSans' fontfile 'Humor-Sans.pfa' 22
set output 'develspeed.eps'
...
plot  jigglea(simple(x)) ls 2 t 'simple', \
      jigglea(easy(x)) ls 1 t 'easy'

#plot  jiggle(simple(x)) ls 10 t '', \
      # jigglea(easy(x)) ls 10 t '', \
